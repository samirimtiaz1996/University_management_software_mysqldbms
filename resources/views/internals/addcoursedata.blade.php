@extends('layouts.app')
@section('title','Add Course Data')
@section('content')
  <div class="row">
    <div class="col-12">
      <h1>courses</h1>

      <form class="pb-5" action="addcoursedata" method="post">
        <div class="form-group pb-2">
          <label for="coursenumber">Course Number:</label>
          <input class="form-control" type="text" name="coursenumber" value="{{ old('coursenumber')}}">
        </div>
        <div class="font-weight-bold">
          {{$errors->first('coursenumber')}}
        </div>
